...
source("0_model/9_mixing_matrix_gmix.R")
## Model flows
...
COVID_sero_vax <- function(t, start, params){
  with(as.list(c(start,params)),{
    ...
    #}
    if(t >=vax_first){
          if((t/vax_int)%%1>(vax_start)&(t/vax_int)%%1<=(vax_end)){
            delta3_ar <-0
            delta3_au <-0
            delta3_er <-0.02
            delta3_eu <-0.02
    ...
    #foi_cr_1v0 = foi_cr_0v0 * red_inf_1 *imm_esc_factor*0.7
    ...
    #foi_cr_2v0 = foi_cr_0v0 * red_inf_2 *imm_esc_factor*0.7
    ...
    foi_cr_0v1 = foi_cr_0v0 * rel_0v1
    foi_cu_0v1 = foi_cu_0v0 * rel_0v1
    foi_ar_0v1 = foi_ar_0v0 * rel_0v1
    foi_au_0v1 = foi_au_0v0 * rel_0v1
    foi_er_0v1 = foi_er_0v0 * rel_0v1
    foi_eu_0v1 = foi_eu_0v0 * rel_0v1
    
    foi_cr_0v2 = foi_cr_0v0 * rel_0v2
    foi_cu_0v2 = foi_cu_0v0 * rel_0v2
    foi_ar_0v2 = foi_ar_0v0 * rel_0v2
    foi_au_0v2 = foi_au_0v0 * rel_0v2
    foi_er_0v2 = foi_er_0v0 * rel_0v2
    foi_eu_0v2 = foi_eu_0v0 * rel_0v2
    
    foi_cr_0v3 = foi_cr_0v0 * rel_0v3
    foi_cu_0v3 = foi_cu_0v0 * rel_0v3
    foi_ar_0v3 = foi_ar_0v0 * rel_0v3
    foi_au_0v3 = foi_au_0v0 * rel_0v3
    foi_er_0v3 = foi_er_0v0 * rel_0v3
    foi_eu_0v3 = foi_eu_0v0 * rel_0v3
    
    ### After first exposure
    foi_cr_1v0 = foi_cr_0v0 * rel_1v0c
    foi_cu_1v0 = foi_cu_0v0 * rel_1v0c
    foi_ar_1v0 = foi_ar_0v0 * rel_1v0
    foi_au_1v0 = foi_au_0v0 * rel_1v0
    foi_er_1v0 = foi_er_0v0 * rel_1v0
    foi_eu_1v0 = foi_eu_0v0 * rel_1v0
    
    foi_cr_1v1 = foi_cr_0v0 * rel_1v1
    foi_cu_1v1 = foi_cu_0v0 * rel_1v1
    foi_ar_1v1 = foi_ar_0v0 * rel_1v1
    foi_au_1v1 = foi_au_0v0 * rel_1v1
    foi_er_1v1 = foi_er_0v0 * rel_1v1
    foi_eu_1v1 = foi_eu_0v0 * rel_1v1
    
    foi_cr_1v2 = foi_cr_0v0 * rel_1v2
    foi_cu_1v2 = foi_cu_0v0 * rel_1v2
    foi_ar_1v2 = foi_ar_0v0 * rel_1v2
    foi_au_1v2 = foi_au_0v0 * rel_1v2
    foi_er_1v2 = foi_er_0v0 * rel_1v2
    foi_eu_1v2 = foi_eu_0v0 * rel_1v2
    
    foi_cr_1v3 = foi_cr_0v0 * rel_1v3
    foi_cu_1v3 = foi_cu_0v0 * rel_1v3
    foi_ar_1v3 = foi_ar_0v0 * rel_1v3
    foi_au_1v3 = foi_au_0v0 * rel_1v3
    foi_er_1v3 = foi_er_0v0 * rel_1v3
    foi_eu_1v3 = foi_eu_0v0 * rel_1v3
    
    ### After second exposure
    foi_cr_2v0 = foi_cr_0v0 * rel_2v0c
    foi_cu_2v0 = foi_cu_0v0 * rel_2v0c
    foi_ar_2v0 = foi_ar_0v0 * rel_2v0
    foi_au_2v0 = foi_au_0v0 * rel_2v0
    foi_er_2v0 = foi_er_0v0 * rel_2v0
    foi_eu_2v0 = foi_eu_0v0 * rel_2v0
    
    foi_cr_2v1 = foi_cr_0v0 * rel_2v1
    foi_cu_2v1 = foi_cu_0v0 * rel_2v1
    foi_ar_2v1 = foi_ar_0v0 * rel_2v1
    foi_au_2v1 = foi_au_0v0 * rel_2v1
    foi_er_2v1 = foi_er_0v0 * rel_2v1
    foi_eu_2v1 = foi_eu_0v0 * rel_2v1
    
    foi_cr_2v2 = foi_cr_0v0 * rel_2v2
    foi_cu_2v2 = foi_cu_0v0 * rel_2v2
    foi_ar_2v2 = foi_ar_0v0 * rel_2v2
    foi_au_2v2 = foi_au_0v0 * rel_2v2
    foi_er_2v2 = foi_er_0v0 * rel_2v2
    foi_eu_2v2 = foi_eu_0v0 * rel_2v2
    
    foi_cr_2v3 = foi_cr_0v0 * rel_2v3
    foi_cu_2v3 = foi_cu_0v0 * rel_2v3
    foi_ar_2v3 = foi_ar_0v0 * rel_2v3
    foi_au_2v3 = foi_au_0v0 * rel_2v3
    foi_er_2v3 = foi_er_0v0 * rel_2v3
    foi_eu_2v3 = foi_eu_0v0 * rel_2v3
    ...
    ################################
    #Susceptible
    dSpcr1v0  = omega_pc*Rpcr1v0 + omega_pc*W1Rpcr1v0 +omega_pc*W2Rpcr1v0 +omega_pc*W3Rpcr1v0 -kappa1*Spcr1v0 - Spcr1v0 * sd * foi_cr_1v0*foi_sp - delta1_cr * Spcr1v0 +omega4_pc*Spcr2v0   ##Note vaccination rate here doesnt differ by previous vax status
    dSpcu1v0  = omega_pc*Rpcu1v0 + omega_pc*W1Rpcu1v0 +omega_pc*W2Rpcu1v0 +omega_pc*W3Rpcu1v0-kappa1*Spcu1v0 -  Spcu1v0 * sd * foi_cu_1v0*foi_sp - delta1_cu * Spcu1v0 + omega4_pc*Spcu2v0
    dSpar1v0  = omega_pa*Rpar1v0 + omega_pa*W1Rpar1v0 +omega_pa*W2Rpar1v0 +omega_pa*W3Rpar1v0 -kappa1*Spar1v0 - Spar1v0 * sd * foi_ar_1v0*foi_sp - delta1_ar * Spar1v0 
    dSpau1v0  = omega_pa*Rpau1v0 + omega_pa*W1Rpau1v0 +omega_pa*W2Rpau1v0 +omega_pa*W3Rpau1v0 -kappa1*Spau1v0 - Spau1v0 * sd * foi_au_1v0*foi_sp - delta1_au * Spau1v0 
    dSper1v0  = omega_pe*Rper1v0 + omega_pe*W1Rper1v0 +omega_pe*W2Rper1v0 +omega_pe*W3Rper1v0 -kappa1*Sper1v0 - Sper1v0 * sd * foi_er_1v0*foi_sp - delta1_er * Sper1v0 
    dSpeu1v0  = omega_pe*Rpeu1v0 + omega_pe*W1Rpeu1v0 +omega_pe*W2Rpeu1v0 +omega_pe*W3Rpeu1v0 -kappa1*Speu1v0 - Speu1v0 * sd * foi_eu_1v0*foi_sp - delta1_eu * Speu1v0 
    
    dSncr1v0  = omega_nc*Rncr1v0 + kappa1*Spcr1v0 -Sncr1v0 * sd * foi_cr_1v0*foi_sn - delta1_cr * Sncr1v0 + omega4_nc*Sncr2v0##Note vaccination rate here doesnt differ by previous vax status
    dSncu1v0  = omega_nc*Rncu1v0 + kappa1*Spcu1v0 -Sncu1v0 * sd * foi_cu_1v0*foi_sn - delta1_cu * Sncu1v0 + omega4_nc*Sncu2v0
    dSnar1v0  = omega_na*Rnar1v0 + kappa1*Spar1v0 -Snar1v0 * sd * foi_ar_1v0*foi_sn - delta1_ar * Snar1v0 
    dSnau1v0  = omega_na*Rnau1v0 + kappa1*Spau1v0 -Snau1v0 * sd * foi_au_1v0*foi_sn - delta1_au * Snau1v0 
    dSner1v0  = omega_ne*Rner1v0 + kappa1*Sper1v0 -Sner1v0 * sd * foi_er_1v0*foi_sn - delta1_er * Sner1v0 
    dSneu1v0  = omega_ne*Rneu1v0 + kappa1*Speu1v0 -Sneu1v0 * sd * foi_eu_1v0*foi_sn - delta1_eu * Sneu1v0 
    
    #Exposed
    dEcr2v0  =  Spcr1v0 * sd * foi_cr_1v0*foi_sp + Sncr1v0 * sd * foi_cr_1v0*foi_sn -  sigma * Ecr2v0  - delta1_cr*Ecr2v0
    dEcu2v0  =  Spcu1v0 * sd * foi_cu_1v0*foi_sp + Sncu1v0 * sd * foi_cu_1v0*foi_sn -  sigma * Ecu2v0  - delta1_cu*Ecu2v0
    dEar2v0  =  Spar1v0 * sd * foi_ar_1v0*foi_sp + Snar1v0 * sd * foi_ar_1v0*foi_sn -  sigma * Ear2v0  - delta1_ar*Ear2v0
    dEau2v0  =  Spau1v0 * sd * foi_au_1v0*foi_sp + Snau1v0 * sd * foi_au_1v0*foi_sn -  sigma * Eau2v0  - delta1_au*Eau2v0
    dEer2v0  =  Sper1v0 * sd * foi_er_1v0*foi_sp + Sner1v0 * sd * foi_er_1v0*foi_sn -  sigma * Eer2v0  - delta1_er*Eer2v0
    dEeu2v0  =  Speu1v0 * sd * foi_eu_1v0*foi_sp + Sneu1v0 * sd * foi_eu_1v0*foi_sn -  sigma * Eeu2v0  - delta1_eu*Eeu2v0
    ...
    ################################
    #Susceptible
    dSpcr2v0  = omega_pc*Rpcr2v0 -kappa2*Spcr2v0 - Spcr2v0 * sd * foi_cr_2v0*foi_sp - delta1_cr * Spcr2v0 + omega2_pc*Rpcr3v0 - omega4_pc*Spcr2v0   ##Note vaccination rate here doesnt differ by previous vax status
    dSpcu2v0  = omega_pc*Rpcu2v0 -kappa2*Spcu2v0 - Spcu2v0 * sd * foi_cu_2v0*foi_sp - delta1_cu * Spcu2v0 + omega2_pc*Rpcu3v0 - omega4_pc*Spcu2v0
    dSpar2v0  = omega_pa*Rpar2v0 -kappa2*Spar2v0 - Spar2v0 * sd * foi_ar_2v0*foi_sp - delta1_ar * Spar2v0 + omega2_pa*Rpar3v0
    dSpau2v0  = omega_pa*Rpau2v0 -kappa2*Spau2v0 - Spau2v0 * sd * foi_au_2v0*foi_sp - delta1_au * Spau2v0 + omega2_pa*Rpau3v0
    dSper2v0  = omega_pe*Rper2v0 -kappa2*Sper2v0 - Sper2v0 * sd * foi_er_2v0*foi_sp - delta1_er * Sper2v0 + omega2_pe*Rper3v0
    dSpeu2v0  = omega_pe*Rpeu2v0 -kappa2*Speu2v0 - Speu2v0 * sd * foi_eu_2v0*foi_sp - delta1_eu * Speu2v0 + omega2_pe*Rpeu3v0
    
    dSncr2v0  = omega_nc*Rncr2v0 + kappa2*Spcr2v0 -Sncr2v0 * sd * foi_cr_2v0*foi_sn - delta1_cr * Sncr2v0 + omega2_nc*Rncr3v0- omega4_nc*Sncr2v0 
    dSncu2v0  = omega_nc*Rncu2v0 + kappa2*Spcu2v0 -Sncu2v0 * sd * foi_cu_2v0*foi_sn - delta1_cu * Sncu2v0 + omega2_nc*Rncu3v0- omega4_nc*Sncu2v0 
    dSnar2v0  = omega_na*Rnar2v0 + kappa2*Spar2v0 -Snar2v0 * sd * foi_ar_2v0*foi_sn - delta1_ar * Snar2v0 + omega2_na*Rnar3v0 
    dSnau2v0  = omega_na*Rnau2v0 + kappa2*Spau2v0 -Snau2v0 * sd * foi_au_2v0*foi_sn - delta1_au * Snau2v0 + omega2_na*Rnau3v0
    dSner2v0  = omega_ne*Rner2v0 + kappa2*Sper2v0 -Sner2v0 * sd * foi_er_2v0*foi_sn - delta1_er * Sner2v0 + omega2_ne*Rner3v0
    dSneu2v0  = omega_ne*Rneu2v0 + kappa2*Speu2v0 -Sneu2v0 * sd * foi_eu_2v0*foi_sn - delta1_eu * Sneu2v0 + omega2_ne*Rneu3v0
    
    #Exposed
    dEcr3v0  =  Spcr2v0 * sd * foi_cr_2v0*foi_sp + Sncr2v0 * sd * foi_cr_2v0*foi_sn -  sigma * Ecr3v0  - delta1_cr*Ecr3v0
    dEcu3v0  =  Spcu2v0 * sd * foi_cu_2v0*foi_sp + Sncu2v0 * sd * foi_cu_2v0*foi_sn -  sigma * Ecu3v0  - delta1_cu*Ecu3v0
    dEar3v0  =  Spar2v0 * sd * foi_ar_2v0*foi_sp + Snar2v0 * sd * foi_ar_2v0*foi_sn -  sigma * Ear3v0  - delta1_ar*Ear3v0
    dEau3v0  =  Spau2v0 * sd * foi_au_2v0*foi_sp + Snau2v0 * sd * foi_au_2v0*foi_sn -  sigma * Eau3v0  - delta1_au*Eau3v0
    dEer3v0  =  Sper2v0 * sd * foi_er_2v0*foi_sp + Sner2v0 * sd * foi_er_2v0*foi_sn -  sigma * Eer3v0  - delta1_er*Eer3v0
    dEeu3v0  =  Speu2v0 * sd * foi_eu_2v0*foi_sp + Sneu2v0 * sd * foi_eu_2v0*foi_sn -  sigma * Eeu3v0  - delta1_eu*Eeu3v0
    ...
    dSpcr0v1  =  omegav_pc *Vpcr0v1+ omegav_pc*W1Vpcr0v1+ omegav_pc*W2Vpcr0v1+ omegav_pc*W3Vpcr0v1 -Spcr0v1 * sd * foi_cr_0v1*foi_sp - delta2_cr * Spcr0v1  -kappa1 * Spcr0v1   
    dSpcu0v1  =  omegav_pc *Vpcu0v1+ omegav_pc*W1Vpcu0v1+ omegav_pc*W2Vpcu0v1+ omegav_pc*W3Vpcu0v1 -Spcu0v1 * sd * foi_cu_0v1*foi_sp - delta2_cu * Spcu0v1  -kappa1 * Spcu0v1  
    dSpar0v1  =  omegav_pa *Vpar0v1+ omegav_pa*W1Vpar0v1+ omegav_pa*W2Vpar0v1+ omegav_pa*W3Vpar0v1 -Spar0v1 * sd * foi_ar_0v1*foi_sp - delta2_ar * Spar0v1  -kappa1 * Spar0v1  
    dSpau0v1  =  omegav_pa *Vpau0v1+ omegav_pa*W1Vpau0v1+ omegav_pa*W2Vpau0v1+ omegav_pa*W3Vpau0v1 -Spau0v1 * sd * foi_au_0v1*foi_sp - delta2_au * Spau0v1  -kappa1 * Spau0v1  
    dSper0v1  =  omegav_pe *Vper0v1+ omegav_pe*W1Vper0v1+ omegav_pe*W2Vper0v1+ omegav_pe*W3Vper0v1 -Sper0v1 * sd * foi_er_0v1*foi_sp - delta2_er * Sper0v1  -kappa1 * Sper0v1  
    dSpeu0v1  =  omegav_pe *Vpeu0v1+ omegav_pe*W1Vpeu0v1+ omegav_pe*W2Vpeu0v1+ omegav_pe*W3Vpeu0v1 -Speu0v1 * sd * foi_eu_0v1*foi_sp - delta2_eu * Speu0v1  -kappa1 * Speu0v1  
    
    # Susceptible and seronegative for S-spike and total IGg
    dSncr0v1  = omegav_nc *Vncr0v1 - Sncr0v1 * sd * foi_cr_0v1*foi_sn - delta2_cr * Sncr0v1 +kappa1 * Spcr0v1 
    dSncu0v1  = omegav_nc *Vncu0v1 - Sncu0v1 * sd * foi_cu_0v1*foi_sn - delta2_cu * Sncu0v1 +kappa1 * Spcu0v1 
    dSnar0v1  = omegav_na *Vnar0v1 - Snar0v1 * sd * foi_ar_0v1*foi_sn - delta2_ar * Snar0v1 +kappa1 * Spar0v1 
    dSnau0v1  = omegav_na *Vnau0v1 - Snau0v1 * sd * foi_au_0v1*foi_sn - delta2_au * Snau0v1 +kappa1 * Spau0v1 
    dSner0v1  = omegav_ne *Vner0v1 - Sner0v1 * sd * foi_er_0v1*foi_sn - delta2_er * Sner0v1 +kappa1 * Sper0v1 
    dSneu0v1  = omegav_ne *Vneu0v1 - Sneu0v1 * sd * foi_eu_0v1*foi_sn - delta2_eu * Sneu0v1 +kappa1 * Speu0v1 
    
    #Exposed
    dEcr1v1  =  Spcr0v1*sd*foi_cr_0v1*foi_sp+Sncr0v1 * sd * foi_cr_0v1*foi_sn -  sigma * Ecr1v1  - delta2_cr*Ecr1v1 +delta1_cr*Ecr1v0
    dEcu1v1  =  Spcu0v1*sd*foi_cu_0v1*foi_sp+Sncu0v1 * sd * foi_cu_0v1*foi_sn- sigma * Ecu1v1  - delta2_cu*Ecu1v1 +delta1_cu*Ecu1v0
    dEar1v1  =  Spar0v1*sd*foi_ar_0v1*foi_sp+Snar0v1 * sd * foi_ar_0v1*foi_sn-  sigma * Ear1v1  - delta2_ar*Ear1v1 +delta1_ar*Ear1v0
    dEau1v1  =  Spau0v1*sd*foi_au_0v1*foi_sp+Snau0v1 * sd * foi_au_0v1*foi_sn-  sigma * Eau1v1  - delta2_au*Eau1v1 +delta1_au*Eau1v0
    dEer1v1  =  Sper0v1*sd*foi_er_0v1*foi_sp+Sner0v1 * sd * foi_er_0v1*foi_sn-  sigma * Eer1v1  - delta2_er*Eer1v1 +delta1_er*Eer1v0
    dEeu1v1  =  Speu0v1*sd*foi_eu_0v1*foi_sp+Sneu0v1 * sd * foi_eu_0v1*foi_sn-  sigma * Eeu1v1  - delta2_eu*Eeu1v1 +delta1_eu*Eeu1v0
    ...
    ################################
    #Susceptible
    dSpcr1v1  = omega_pc*Rpcr1v1 -kappa2*Spcr1v1 - Spcr1v1 * sd * foi_cr_1v1*foi_sp - delta2_cr * Spcr1v1 
    dSpcu1v1  = omega_pc*Rpcu1v1 -kappa2*Spcu1v1 - Spcu1v1 * sd * foi_cu_1v1*foi_sp - delta2_cu * Spcu1v1 
    dSpar1v1  = omega_pa*Rpar1v1 -kappa2*Spar1v1 - Spar1v1 * sd * foi_ar_1v1*foi_sp - delta2_ar * Spar1v1 
    dSpau1v1  = omega_pa*Rpau1v1 -kappa2*Spau1v1 - Spau1v1 * sd * foi_au_1v1*foi_sp - delta2_au * Spau1v1 
    dSper1v1  = omega_pe*Rper1v1 -kappa2*Sper1v1 - Sper1v1 * sd * foi_er_1v1*foi_sp - delta2_er * Sper1v1  
    dSpeu1v1  = omega_pe*Rpeu1v1 -kappa2*Speu1v1 - Speu1v1 * sd * foi_eu_1v1*foi_sp - delta2_eu * Speu1v1 
    
    dSncr1v1  = omega_nc*Rncr1v1 + kappa2*Spcr1v1 -Sncr1v1 * sd * foi_cr_1v1*foi_sn - delta2_cr * Sncr1v1  
    dSncu1v1  = omega_nc*Rncu1v1 + kappa2*Spcu1v1 -Sncu1v1 * sd * foi_cu_1v1*foi_sn - delta2_cu * Sncu1v1 
    dSnar1v1  = omega_na*Rnar1v1 + kappa2*Spar1v1 -Snar1v1 * sd * foi_ar_1v1*foi_sn - delta2_ar * Snar1v1 
    dSnau1v1  = omega_na*Rnau1v1 + kappa2*Spau1v1 -Snau1v1 * sd * foi_au_1v1*foi_sn - delta2_au * Snau1v1 
    dSner1v1  = omega_ne*Rner1v1 + kappa2*Sper1v1 -Sner1v1 * sd * foi_er_1v1*foi_sn - delta2_er * Sner1v1 
    dSneu1v1  = omega_ne*Rneu1v1 + kappa2*Speu1v1 -Sneu1v1 * sd * foi_eu_1v1*foi_sn - delta2_eu * Sneu1v1 
    
    #Exposed
    dEcr2v1  =  Spcr1v1 * sd * foi_cr_1v1*foi_sp + Sncr1v1 * sd * foi_cr_1v1*foi_sn -  sigma * Ecr2v1  - delta2_cr*Ecr2v1 +delta1_cr*Ecr2v0
    dEcu2v1  =  Spcu1v1 * sd * foi_cu_1v1*foi_sp + Sncu1v1 * sd * foi_cu_1v1*foi_sn -  sigma * Ecu2v1  - delta2_cu*Ecu2v1 +delta1_cu*Ecu2v0
    dEar2v1  =  Spar1v1 * sd * foi_ar_1v1*foi_sp + Snar1v1 * sd * foi_ar_1v1*foi_sn -  sigma * Ear2v1  - delta2_ar*Ear2v1 +delta1_ar*Ear2v0
    dEau2v1  =  Spau1v1 * sd * foi_au_1v1*foi_sp + Snau1v1 * sd * foi_au_1v1*foi_sn -  sigma * Eau2v1  - delta2_au*Eau2v1 +delta1_au*Eau2v0
    dEer2v1  =  Sper1v1 * sd * foi_er_1v1*foi_sp + Sner1v1 * sd * foi_er_1v1*foi_sn -  sigma * Eer2v1  - delta2_er*Eer2v1 +delta1_er*Eer2v0
    dEeu2v1  =  Speu1v1 * sd * foi_eu_1v1*foi_sp + Sneu1v1 * sd * foi_eu_1v1*foi_sn -  sigma * Eeu2v1  - delta2_eu*Eeu2v1 +delta1_eu*Eeu2v0
    ...
    ################################
    #Susceptible
    dSpcr2v1  = omega_pc*Rpcr2v1 -kappa3*Spcr2v1 - Spcr2v1 * sd * foi_cr_2v1*foi_sp - delta2_cr * Spcr2v1  + omega2_pc*Rpcr3v1
    dSpcu2v1  = omega_pc*Rpcu2v1 -kappa3*Spcu2v1 - Spcu2v1 * sd * foi_cu_2v1*foi_sp - delta2_cu * Spcu2v1  + omega2_pc*Rpcu3v1
    dSpar2v1  = omega_pa*Rpar2v1 -kappa3*Spar2v1 - Spar2v1 * sd * foi_ar_2v1*foi_sp - delta2_ar * Spar2v1  + omega2_pa*Rpar3v1
    dSpau2v1  = omega_pa*Rpau2v1 -kappa3*Spau2v1 - Spau2v1 * sd * foi_au_2v1*foi_sp - delta2_au * Spau2v1  + omega2_pa*Rpau3v1
    dSper2v1  = omega_pe*Rper2v1 -kappa3*Sper2v1 - Sper2v1 * sd * foi_er_2v1*foi_sp - delta2_er * Sper2v1  + omega2_pe*Rper3v1
    dSpeu2v1  = omega_pe*Rpeu2v1 -kappa3*Speu2v1 - Speu2v1 * sd * foi_eu_2v1*foi_sp - delta2_eu * Speu2v1  + omega2_pe*Rpeu3v1
    
    dSncr2v1  = omega_nc*Rncr2v1 + kappa3*Spcr2v1 -Sncr2v1 * sd * foi_cr_2v1*foi_sn - delta2_cr * Sncr2v1 + omega2_nc*Rncr3v1
    dSncu2v1  = omega_nc*Rncu2v1 + kappa3*Spcu2v1 -Sncu2v1 * sd * foi_cu_2v1*foi_sn - delta2_cu * Sncu2v1 + omega2_nc*Rncu3v1
    dSnar2v1  = omega_na*Rnar2v1 + kappa3*Spar2v1 -Snar2v1 * sd * foi_ar_2v1*foi_sn - delta2_ar * Snar2v1 + omega2_na*Rnar3v1
    dSnau2v1  = omega_na*Rnau2v1 + kappa3*Spau2v1 -Snau2v1 * sd * foi_au_2v1*foi_sn - delta2_au * Snau2v1 + omega2_na*Rnau3v1
    dSner2v1  = omega_ne*Rner2v1 + kappa3*Sper2v1 -Sner2v1 * sd * foi_er_2v1*foi_sn - delta2_er * Sner2v1 + omega2_ne*Rner3v1
    dSneu2v1  = omega_ne*Rneu2v1 + kappa3*Speu2v1 -Sneu2v1 * sd * foi_eu_2v1*foi_sn - delta2_eu * Sneu2v1 + omega2_ne*Rneu3v1
    
    #Exposed
    dEcr3v1  =  Spcr2v1 * sd * foi_cr_2v1*foi_sp + Sncr2v1 * sd * foi_cr_2v1*foi_sn -  sigma * Ecr3v1  - delta2_cr*Ecr3v1 + delta1_cr*Ecr3v0
    dEcu3v1  =  Spcu2v1 * sd * foi_cu_2v1*foi_sp + Sncu2v1 * sd * foi_cu_2v1*foi_sn -  sigma * Ecu3v1  - delta2_cu*Ecu3v1 + delta1_cu*Ecu3v0
    dEar3v1  =  Spar2v1 * sd * foi_ar_2v1*foi_sp + Snar2v1 * sd * foi_ar_2v1*foi_sn -  sigma * Ear3v1  - delta2_ar*Ear3v1 + delta1_ar*Ear3v0
    dEau3v1  =  Spau2v1 * sd * foi_au_2v1*foi_sp + Snau2v1 * sd * foi_au_2v1*foi_sn -  sigma * Eau3v1  - delta2_au*Eau3v1 + delta1_au*Eau3v0
    dEer3v1  =  Sper2v1 * sd * foi_er_2v1*foi_sp + Sner2v1 * sd * foi_er_2v1*foi_sn -  sigma * Eer3v1  - delta2_er*Eer3v1 + delta1_er*Eer3v0
    dEeu3v1  =  Speu2v1 * sd * foi_eu_2v1*foi_sp + Sneu2v1 * sd * foi_eu_2v1*foi_sn -  sigma * Eeu3v1  - delta2_eu*Eeu3v1 + delta1_eu*Eeu3v0
    ...
    ################################
    #Susceptible and seropositive with S-spike and total IGg
    dSpcr0v2  = omegav_pc*Vpcr0v2 -Spcr0v2 * sd * foi_cr_0v2*foi_sp - delta3_cr * Spcr0v2  -kappa2 * Spcr0v2 +omega3_pc*Spcr0v3
    dSpcu0v2  = omegav_pc*Vpcu0v2 -Spcu0v2 * sd * foi_cu_0v2*foi_sp - delta3_cu * Spcu0v2  -kappa2 * Spcu0v2 +omega3_pc*Spcu0v3
    dSpar0v2  = omegav_pa*Vpar0v2 -Spar0v2 * sd * foi_ar_0v2*foi_sp - delta3_ar * Spar0v2  -kappa2 * Spar0v2 +omega3_pa*Spar0v3
    dSpau0v2  = omegav_pa*Vpau0v2 -Spau0v2 * sd * foi_au_0v2*foi_sp - delta3_au * Spau0v2  -kappa2 * Spau0v2 +omega3_pa*Spau0v3
    dSper0v2  = omegav_pe*Vper0v2 -Sper0v2 * sd * foi_er_0v2*foi_sp - delta3_er * Sper0v2  -kappa2 * Sper0v2 +omega3_pe*Sper0v3
    dSpeu0v2  = omegav_pe*Vpeu0v2 -Speu0v2 * sd * foi_eu_0v2*foi_sp - delta3_eu * Speu0v2  -kappa2 * Speu0v2 +omega3_pe*Speu0v3
    
    #Susceptible
    dSncr0v2  = omegav_nc*Vncr0v2 -Sncr0v2 * sd * foi_cr_0v2*foi_sn - delta3_cr * Sncr0v2 +kappa2 * Spcr0v2 +omega3_nc*Sncr0v3
    dSncu0v2  = omegav_nc*Vncu0v2 -Sncu0v2 * sd * foi_cu_0v2*foi_sn - delta3_cu * Sncu0v2 +kappa2 * Spcu0v2 +omega3_nc*Sncu0v3
    dSnar0v2  = omegav_na*Vnar0v2 -Snar0v2 * sd * foi_ar_0v2*foi_sn - delta3_ar * Snar0v2 +kappa2 * Spar0v2 +omega3_na*Snar0v3
    dSnau0v2  = omegav_na*Vnau0v2 -Snau0v2 * sd * foi_au_0v2*foi_sn - delta3_au * Snau0v2 +kappa2 * Spau0v2 +omega3_na*Snau0v3
    dSner0v2  = omegav_ne*Vner0v2 -Sner0v2 * sd * foi_er_0v2*foi_sn - delta3_er * Sner0v2 +kappa2 * Sper0v2 +omega3_ne*Sner0v3
    dSneu0v2  = omegav_ne*Vneu0v2 -Sneu0v2 * sd * foi_eu_0v2*foi_sn - delta3_eu * Sneu0v2 +kappa2 * Speu0v2 +omega3_ne*Sneu0v3
    
    #Exposed
    dEcr1v2  =  Spcr0v2 * sd * foi_cr_0v2*foi_sp + Sncr0v2 * sd * foi_cr_0v2*foi_sn-  sigma * Ecr1v2  - delta3_cr*Ecr1v2 +delta2_cr*Ecr1v1
    dEcu1v2  =  Spcu0v2 * sd * foi_cu_0v2*foi_sp + Sncu0v2 * sd * foi_cu_0v2*foi_sn-  sigma * Ecu1v2  - delta3_cu*Ecu1v2 +delta2_cu*Ecu1v1
    dEar1v2  =  Spar0v2 * sd * foi_ar_0v2*foi_sp + Snar0v2 * sd * foi_ar_0v2*foi_sn-  sigma * Ear1v2  - delta3_ar*Ear1v2 +delta2_ar*Ear1v1
    dEau1v2  =  Spau0v2 * sd * foi_au_0v2*foi_sp + Snau0v2 * sd * foi_au_0v2*foi_sn-  sigma * Eau1v2  - delta3_au*Eau1v2 +delta2_au*Eau1v1
    dEer1v2  =  Sper0v2 * sd * foi_er_0v2*foi_sp + Sner0v2 * sd * foi_er_0v2*foi_sn-  sigma * Eer1v2  - delta3_er*Eer1v2 +delta2_er*Eer1v1
    dEeu1v2  =  Speu0v2 * sd * foi_eu_0v2*foi_sp + Sneu0v2 * sd * foi_eu_0v2*foi_sn-  sigma * Eeu1v2  - delta3_eu*Eeu1v2 +delta2_eu*Eeu1v1
    ...
    ################################
    #Susceptible
    dSpcr1v2  = omega_pc*Rpcr1v2 -kappa3*Spcr1v2 - Spcr1v2 * sd * foi_cr_1v2*foi_sp - delta3_cr * Spcr1v2 +omega3_pc*Spcr1v3 
    dSpcu1v2  = omega_pc*Rpcu1v2 -kappa3*Spcu1v2 - Spcu1v2 * sd * foi_cu_1v2*foi_sp - delta3_cu * Spcu1v2 +omega3_pc*Spcu1v3 
    dSpar1v2  = omega_pa*Rpar1v2 -kappa3*Spar1v2 - Spar1v2 * sd * foi_ar_1v2*foi_sp - delta3_ar * Spar1v2 +omega3_pa*Spar1v3 + omega4_pa*Spar2v2
    dSpau1v2  = omega_pa*Rpau1v2 -kappa3*Spau1v2 - Spau1v2 * sd * foi_au_1v2*foi_sp - delta3_au * Spau1v2 +omega3_pa*Spau1v3 + omega4_pa*Spau2v2
    dSper1v2  = omega_pe*Rper1v2 -kappa3*Sper1v2 - Sper1v2 * sd * foi_er_1v2*foi_sp - delta3_er * Sper1v2 +omega3_pe*Sper1v3 + omega4_pe*Sper2v2
    dSpeu1v2  = omega_pe*Rpeu1v2 -kappa3*Speu1v2 - Speu1v2 * sd * foi_eu_1v2*foi_sp - delta3_eu * Speu1v2 +omega3_pe*Speu1v3 + omega4_pe*Speu2v2
    
    dSncr1v2  = omega_nc*Rncr1v2 + kappa3*Spcr1v2 -Sncr1v2 * sd * foi_cr_1v2*foi_sn - delta3_cr * Sncr1v2 +omega3_nc*Sncr1v3 
    dSncu1v2  = omega_nc*Rncu1v2 + kappa3*Spcu1v2 -Sncu1v2 * sd * foi_cu_1v2*foi_sn - delta3_cu * Sncu1v2 +omega3_nc*Sncu1v3
    dSnar1v2  = omega_na*Rnar1v2 + kappa3*Spar1v2 -Snar1v2 * sd * foi_ar_1v2*foi_sn - delta3_ar * Snar1v2 +omega3_na*Snar1v3 +omega4_na*Snar2v2
    dSnau1v2  = omega_na*Rnau1v2 + kappa3*Spau1v2 -Snau1v2 * sd * foi_au_1v2*foi_sn - delta3_au * Snau1v2 +omega3_na*Snau1v3 +omega4_na*Snau2v2
    dSner1v2  = omega_ne*Rner1v2 + kappa3*Sper1v2 -Sner1v2 * sd * foi_er_1v2*foi_sn - delta3_er * Sner1v2 +omega3_ne*Sner1v3 +omega4_ne*Sner2v2
    dSneu1v2  = omega_ne*Rneu1v2 + kappa3*Speu1v2 -Sneu1v2 * sd * foi_eu_1v2*foi_sn - delta3_eu * Sneu1v2 +omega3_ne*Sneu1v3 +omega4_ne*Sneu2v2
    
    #Exposed
    dEcr2v2  =  Spcr1v2 * sd * foi_cr_1v2*foi_sp + Sncr1v2 * sd * foi_cr_1v2*foi_sn -  sigma * Ecr2v2  - delta3_cr*Ecr2v2 +delta2_cr*Ecr2v1
    dEcu2v2  =  Spcu1v2 * sd * foi_cu_1v2*foi_sp + Sncu1v2 * sd * foi_cu_1v2*foi_sn -  sigma * Ecu2v2  - delta3_cu*Ecu2v2 +delta2_cu*Ecu2v1
    dEar2v2  =  Spar1v2 * sd * foi_ar_1v2*foi_sp + Snar1v2 * sd * foi_ar_1v2*foi_sn -  sigma * Ear2v2  - delta3_ar*Ear2v2 +delta2_ar*Ear2v1
    dEau2v2  =  Spau1v2 * sd * foi_au_1v2*foi_sp + Snau1v2 * sd * foi_au_1v2*foi_sn -  sigma * Eau2v2  - delta3_au*Eau2v2 +delta2_au*Eau2v1
    dEer2v2  =  Sper1v2 * sd * foi_er_1v2*foi_sp + Sner1v2 * sd * foi_er_1v2*foi_sn -  sigma * Eer2v2  - delta3_er*Eer2v2 +delta2_er*Eer2v1
    dEeu2v2  =  Speu1v2 * sd * foi_eu_1v2*foi_sp + Sneu1v2 * sd * foi_eu_1v2*foi_sn -  sigma * Eeu2v2  - delta3_eu*Eeu2v2 +delta2_eu*Eeu2v1
    ...
    ################################
    #Susceptible
    dSpcr2v2  = omega_pc*Rpcr2v2 -kappa3*Spcr2v2 - Spcr2v2 * sd * foi_cr_2v2*foi_sp - delta3_cr * Spcr2v2 + delta2_cr*Spcr2v1+ delta2_cr*Sncr2v1*(rho_v2)+ omega2_pc*Rpcr3v2 +omega3_pc*Spcr2v3  
    dSpcu2v2  = omega_pc*Rpcu2v2 -kappa3*Spcu2v2 - Spcu2v2 * sd * foi_cu_2v2*foi_sp - delta3_cu * Spcu2v2 + delta2_cu*Spcu2v1+ delta2_cu*Sncu2v1*(rho_v2)+ omega2_pc*Rpcu3v2 +omega3_pc*Spcu2v3 
    dSpar2v2  = omega_pa*Rpar2v2 -kappa3*Spar2v2 - Spar2v2 * sd * foi_ar_2v2*foi_sp - delta3_ar * Spar2v2 + delta2_ar*Spar2v1+ delta2_ar*Snar2v1*(rho_v2)+ omega2_pa*Rpar3v2 +omega3_pa*Spar2v3 -omega4_pa*Spar2v2
    dSpau2v2  = omega_pa*Rpau2v2 -kappa3*Spau2v2 - Spau2v2 * sd * foi_au_2v2*foi_sp - delta3_au * Spau2v2 + delta2_au*Spau2v1+ delta2_au*Snau2v1*(rho_v2)+ omega2_pa*Rpau3v2 +omega3_pa*Spau2v3 -omega4_pa*Spau2v2
    dSper2v2  = omega_pe*Rper2v2 -kappa3*Sper2v2 - Sper2v2 * sd * foi_er_2v2*foi_sp - delta3_er * Sper2v2 + delta2_er*Sper2v1+ delta2_er*Sner2v1*(rho_v2)+ omega2_pe*Rper3v2 +omega3_pe*Sper2v3 -omega4_pe*Sper2v2
    dSpeu2v2  = omega_pe*Rpeu2v2 -kappa3*Speu2v2 - Speu2v2 * sd * foi_eu_2v2*foi_sp - delta3_eu * Speu2v2 + delta2_eu*Speu2v1+ delta2_eu*Sneu2v1*(rho_v2)+ omega2_pe*Rpeu3v2 +omega3_pe*Speu2v3 -omega4_pe*Speu2v2
    
    dSncr2v2  = omega_nc*Rncr2v2 + kappa3*Spcr2v2 -Sncr2v2 * sd * foi_cr_2v2*foi_sn - delta3_cr * Sncr2v2 + delta2_cr*Sncr2v1*(1-rho_v2) + omega2_nc*Rncr3v2 +omega3_nc*Sncr2v3
    dSncu2v2  = omega_nc*Rncu2v2 + kappa3*Spcu2v2 -Sncu2v2 * sd * foi_cu_2v2*foi_sn  - delta3_cu * Sncu2v2 + delta2_cu*Sncu2v1*(1-rho_v2) + omega2_nc*Rncu3v2 +omega3_nc*Sncu2v3
    dSnar2v2  = omega_na*Rnar2v2 + kappa3*Spar2v2 -Snar2v2 * sd * foi_ar_2v2*foi_sn  - delta3_ar * Snar2v2 + delta2_ar*Snar2v1*(1-rho_v2) + omega2_na*Rnar3v2 +omega3_na*Snar2v3-omega4_na*Snar2v2
    dSnau2v2  = omega_na*Rnau2v2 + kappa3*Spau2v2 -Snau2v2 * sd * foi_au_2v2*foi_sn  - delta3_au * Snau2v2 + delta2_au*Snau2v1*(1-rho_v2) + omega2_na*Rnau3v2 +omega3_na*Snau2v3-omega4_na*Snau2v2
    dSner2v2  = omega_ne*Rner2v2 + kappa3*Sper2v2 -Sner2v2 * sd * foi_er_2v2*foi_sn  - delta3_er * Sner2v2 + delta2_er*Sner2v1*(1-rho_v2) + omega2_ne*Rner3v2 +omega3_ne*Sner2v3-omega4_ne*Sner2v2
    dSneu2v2  = omega_ne*Rneu2v2 + kappa3*Speu2v2 -Sneu2v2 * sd * foi_eu_2v2*foi_sn  - delta3_eu * Sneu2v2 + delta2_eu*Sneu2v1*(1-rho_v2) + omega2_ne*Rneu3v2 +omega3_ne*Sneu2v3-omega4_ne*Sneu2v2
    
    #Exposed
    dEcr3v2  =  Spcr2v2 * sd * foi_cr_2v2*foi_sp + Sncr2v2 * sd * foi_cr_2v2*foi_sn  -  sigma * Ecr3v2  - delta3_cr*Ecr3v2 + delta2_cr*Ecr3v1
    dEcu3v2  =  Spcu2v2 * sd * foi_cu_2v2*foi_sp + Sncu2v2 * sd * foi_cu_2v2*foi_sn  -  sigma * Ecu3v2  - delta3_cu*Ecu3v2 + delta2_cu*Ecu3v1
    dEar3v2  =  Spar2v2 * sd * foi_ar_2v2*foi_sp + Snar2v2 * sd * foi_ar_2v2*foi_sn  -  sigma * Ear3v2  - delta3_ar*Ear3v2 + delta2_ar*Ear3v1
    dEau3v2  =  Spau2v2 * sd * foi_au_2v2*foi_sp + Snau2v2 * sd * foi_au_2v2*foi_sn  -  sigma * Eau3v2  - delta3_au*Eau3v2 + delta2_au*Eau3v1
    dEer3v2  =  Sper2v2 * sd * foi_er_2v2*foi_sp + Sner2v2 * sd * foi_er_2v2*foi_sn  -  sigma * Eer3v2  - delta3_er*Eer3v2 + delta2_er*Eer3v1
    dEeu3v2  =  Speu2v2 * sd * foi_eu_2v2*foi_sp + Sneu2v2 * sd * foi_eu_2v2*foi_sn  -  sigma * Eeu3v2  - delta3_eu*Eeu3v2 + delta2_eu*Eeu3v1
    ...
    dSpcr0v3  = omegav_pc*Vpcr0v3 -Spcr0v3 * sd * foi_cr_0v3*foi_sp - kappa3*Spcr0v3 - omega3_pc*Spcr0v3 +delta3_cr*Sncr0v3*rho_v3
    dSpcu0v3  = omegav_pc*Vpcu0v3 -Spcu0v3 * sd * foi_cu_0v3*foi_sp - kappa3*Spcu0v3 - omega3_pc*Spcu0v3 +delta3_cu*Sncu0v3*rho_v3
    dSpar0v3  = omegav_pa*Vpar0v3 -Spar0v3 * sd * foi_ar_0v3*foi_sp - kappa3*Spar0v3 - omega3_pa*Spar0v3 +delta3_ar*Snar0v3*rho_v3
    dSpau0v3  = omegav_pa*Vpau0v3 -Spau0v3 * sd * foi_au_0v3*foi_sp - kappa3*Spau0v3 - omega3_pa*Spau0v3 +delta3_au*Snau0v3*rho_v3
    dSper0v3  = omegav_pe*Vper0v3 -Sper0v3 * sd * foi_er_0v3*foi_sp - kappa3*Sper0v3 - omega3_pe*Sper0v3 +delta3_er*Sner0v3*rho_v3
    dSpeu0v3  = omegav_pe*Vpeu0v3 -Speu0v3 * sd * foi_eu_0v3*foi_sp - kappa3*Speu0v3 - omega3_pe*Speu0v3 +delta3_eu*Sneu0v3*rho_v3
    
    
    #Susceptible seronegative
    dSncr0v3  = omegav_nc*Vncr0v3 -Sncr0v3*sd*foi_cr_0v3*foi_sn + kappa3*Spcr0v3 - delta3_cr*Sncr0v3*rho_v3 - omega3_nc*Sncr0v3
    dSncu0v3  = omegav_nc*Vncu0v3 -Sncu0v3*sd*foi_cu_0v3*foi_sn + kappa3*Spcu0v3 - delta3_cu*Sncu0v3*rho_v3 - omega3_nc*Sncu0v3
    dSnar0v3  = omegav_na*Vnar0v3 -Snar0v3*sd*foi_ar_0v3*foi_sn + kappa3*Spar0v3 - delta3_ar*Snar0v3*rho_v3 - omega3_na*Snar0v3
    dSnau0v3  = omegav_na*Vnau0v3 -Snau0v3*sd*foi_au_0v3*foi_sn + kappa3*Spau0v3 - delta3_au*Snau0v3*rho_v3 - omega3_na*Snau0v3
    dSner0v3  = omegav_ne*Vner0v3 -Sner0v3*sd*foi_er_0v3*foi_sn + kappa3*Sper0v3 - delta3_er*Sner0v3*rho_v3 - omega3_ne*Sner0v3
    dSneu0v3  = omegav_ne*Vneu0v3 -Sneu0v3*sd*foi_eu_0v3*foi_sn + kappa3*Speu0v3 - delta3_eu*Sneu0v3*rho_v3 - omega3_ne*Sneu0v3
    
    #Exposed
    dEcr1v3  =  Spcr0v3 * sd * foi_cr_0v3*foi_sp + Sncr0v3 * sd * foi_cr_0v3*foi_sn-  sigma * Ecr1v3 +delta3_cr*Ecr1v2
    dEcu1v3  =  Spcu0v3 * sd * foi_cu_0v3*foi_sp + Sncu0v3 * sd * foi_cu_0v3*foi_sn-  sigma * Ecu1v3 +delta3_cu*Ecu1v2
    dEar1v3  =  Spar0v3 * sd * foi_ar_0v3*foi_sp + Snar0v3 * sd * foi_ar_0v3*foi_sn-  sigma * Ear1v3 +delta3_ar*Ear1v2
    dEau1v3  =  Spau0v3 * sd * foi_au_0v3*foi_sp + Snau0v3 * sd * foi_au_0v3*foi_sn-  sigma * Eau1v3 +delta3_au*Eau1v2
    dEer1v3  =  Sper0v3 * sd * foi_er_0v3*foi_sp + Sner0v3 * sd * foi_er_0v3*foi_sn-  sigma * Eer1v3 +delta3_er*Eer1v2
    dEeu1v3  =  Speu0v3 * sd * foi_eu_0v3*foi_sp + Sneu0v3 * sd * foi_eu_0v3*foi_sn-  sigma * Eeu1v3 +delta3_eu*Eeu1v2
    ...
    ################################
    #Susceptible
    dSpcr1v3  = omega_pc*Rpcr1v3 -kappa3*Spcr1v3 - Spcr1v3 * sd * foi_cr_1v3*foi_sp  - omega3_pc*Spcr1v3+delta3_cr * Sncr1v3*rho_v3
    dSpcu1v3  = omega_pc*Rpcu1v3 -kappa3*Spcu1v3 - Spcu1v3 * sd * foi_cu_1v3*foi_sp  - omega3_pc*Spcu1v3+delta3_cu * Sncu1v3*rho_v3
    dSpar1v3  = omega_pa*Rpar1v3 -kappa3*Spar1v3 - Spar1v3 * sd * foi_ar_1v3*foi_sp  - omega3_pa*Spar1v3+delta3_ar * Snar1v3*rho_v3
    dSpau1v3  = omega_pa*Rpau1v3 -kappa3*Spau1v3 - Spau1v3 * sd * foi_au_1v3*foi_sp  - omega3_pa*Spau1v3+delta3_au * Snau1v3*rho_v3
    dSper1v3  = omega_pe*Rper1v3 -kappa3*Sper1v3 - Sper1v3 * sd * foi_er_1v3*foi_sp  - omega3_pe*Sper1v3+delta3_er * Sner1v3*rho_v3 +omega4_pe*Sper2v3
    dSpeu1v3  = omega_pe*Rpeu1v3 -kappa3*Speu1v3 - Speu1v3 * sd * foi_eu_1v3*foi_sp  - omega3_pe*Speu1v3+delta3_eu * Sneu1v3*rho_v3 +omega4_pe*Speu2v3
    
    dSncr1v3  = omega_pc*Rncr1v3 + kappa3*Spcr1v3 -Sncr1v3 * sd * foi_cr_1v3*foi_sn - omega3_nc*Sncr1v3- delta3_cr * Sncr1v3*rho_v3 
    dSncu1v3  = omega_pc*Rncu1v3 + kappa3*Spcu1v3 -Sncu1v3 * sd * foi_cu_1v3*foi_sn - omega3_nc*Sncu1v3- delta3_cu * Sncu1v3*rho_v3 
    dSnar1v3  = omega_pa*Rnar1v3 + kappa3*Spar1v3 -Snar1v3 * sd * foi_ar_1v3*foi_sn - omega3_na*Snar1v3- delta3_ar * Snar1v3*rho_v3
    dSnau1v3  = omega_pa*Rnau1v3 + kappa3*Spau1v3 -Snau1v3 * sd * foi_au_1v3*foi_sn - omega3_na*Snau1v3- delta3_au * Snau1v3*rho_v3 
    dSner1v3  = omega_pe*Rner1v3 + kappa3*Sper1v3 -Sner1v3 * sd * foi_er_1v3*foi_sn - omega3_ne*Sner1v3- delta3_er * Sner1v3*rho_v3 +omega4_ne*Sner2v3
    dSneu1v3  = omega_pe*Rneu1v3 + kappa3*Speu1v3 -Sneu1v3 * sd * foi_eu_1v3*foi_sn - omega3_ne*Sneu1v3- delta3_eu * Sneu1v3*rho_v3 +omega4_ne*Sneu2v3
    
    #Exposed
    dEcr2v3  =  Spcr1v3 * sd * foi_cr_1v3*foi_sp + Sncr1v3 * sd * foi_cr_1v3*foi_sn -  sigma * Ecr2v3   +delta3_cr*Ecr2v2
    dEcu2v3  =  Spcu1v3 * sd * foi_cu_1v3*foi_sp + Sncu1v3 * sd * foi_cu_1v3*foi_sn -  sigma * Ecu2v3   +delta3_cu*Ecu2v2
    dEar2v3  =  Spar1v3 * sd * foi_ar_1v3*foi_sp + Snar1v3 * sd * foi_ar_1v3*foi_sn -  sigma * Ear2v3   +delta3_ar*Ear2v2
    dEau2v3  =  Spau1v3 * sd * foi_au_1v3*foi_sp + Snau1v3 * sd * foi_au_1v3*foi_sn -  sigma * Eau2v3   +delta3_au*Eau2v2
    dEer2v3  =  Sper1v3 * sd * foi_er_1v3*foi_sp + Sner1v3 * sd * foi_er_1v3*foi_sn -  sigma * Eer2v3   +delta3_er*Eer2v2
    dEeu2v3  =  Speu1v3 * sd * foi_eu_1v3*foi_sp + Sneu1v3 * sd * foi_eu_1v3*foi_sn -  sigma * Eeu2v3   +delta3_eu*Eeu2v2
    ...
    ################################
    #Susceptible
    dSpcr2v3  = omega_pc*Rpcr2v3 -kappa3*Spcr2v3 - Spcr2v3 * sd * foi_cr_2v3*foi_sp + delta3_cr * Sncr2v3*rho_v3  + omega2_pc*Rpcr3v3 - omega3_pc*Spcr2v3
    dSpcu2v3  = omega_pc*Rpcu2v3 -kappa3*Spcu2v3 - Spcu2v3 * sd * foi_cu_2v3*foi_sp + delta3_cu * Sncu2v3*rho_v3  + omega2_pc*Rpcu3v3 - omega3_pc*Spcu2v3
    dSpar2v3  = omega_pa*Rpar2v3 -kappa3*Spar2v3 - Spar2v3 * sd * foi_ar_2v3*foi_sp + delta3_ar * Snar2v3*rho_v3  + omega2_pa*Rpar3v3 - omega3_pa*Spar2v3
    dSpau2v3  = omega_pa*Rpau2v3 -kappa3*Spau2v3 - Spau2v3 * sd * foi_au_2v3*foi_sp + delta3_au * Snau2v3*rho_v3  + omega2_pa*Rpau3v3 - omega3_pa*Spau2v3
    dSper2v3  = omega_pe*Rper2v3 -kappa3*Sper2v3 - Sper2v3 * sd * foi_er_2v3*foi_sp + delta3_er * Sner2v3*rho_v3  + omega2_pe*Rper3v3 - omega3_pe*Sper2v3 - omega4_pe*Sper2v3
    dSpeu2v3  = omega_pe*Rpeu2v3 -kappa3*Speu2v3 - Speu2v3 * sd * foi_eu_2v3*foi_sp + delta3_eu * Sneu2v3*rho_v3  + omega2_pe*Rpeu3v3 - omega3_pe*Speu2v3 - omega4_pe*Speu2v3
    
    dSncr2v3  = omega_pc*Rncr2v3 + kappa3*Spcr2v3 -Sncr2v3 * sd * foi_cr_2v3*foi_sn - delta3_cr * Sncr2v3*rho_v3  + omega2_nc*Rncr3v3 - omega3_nc*Sncr2v3
    dSncu2v3  = omega_pc*Rncu2v3 + kappa3*Spcu2v3 -Sncu2v3 * sd * foi_cu_2v3*foi_sn - delta3_cu * Sncu2v3*rho_v3  + omega2_nc*Rncu3v3 - omega3_nc*Sncu2v3
    dSnar2v3  = omega_pa*Rnar2v3 + kappa3*Spar2v3 -Snar2v3 * sd * foi_ar_2v3*foi_sn - delta3_ar * Snar2v3*rho_v3  + omega2_na*Rnar3v3 - omega3_na*Snar2v3
    dSnau2v3  = omega_pa*Rnau2v3 + kappa3*Spau2v3 -Snau2v3 * sd * foi_au_2v3*foi_sn - delta3_au * Snau2v3*rho_v3  + omega2_na*Rnau3v3 - omega3_na*Snau2v3
    dSner2v3  = omega_pe*Rner2v3 + kappa3*Sper2v3 -Sner2v3 * sd * foi_er_2v3*foi_sn - delta3_er * Sner2v3*rho_v3  + omega2_ne*Rner3v3 - omega3_ne*Sner2v3- omega4_ne*Sner2v3
    dSneu2v3  = omega_pe*Rneu2v3 + kappa3*Speu2v3 -Sneu2v3 * sd * foi_eu_2v3*foi_sn - delta3_eu * Sneu2v3*rho_v3  + omega2_ne*Rneu3v3 - omega3_ne*Sneu2v3- omega4_ne*Sneu2v3
    
    #Exposed
    dEcr3v3  =  Spcr2v3 * sd * foi_cr_2v3*foi_sp + Sncr2v3 * sd * foi_cr_2v3*foi_sn -  sigma * Ecr3v3  + delta3_cr*Ecr3v2
    dEcu3v3  =  Spcu2v3 * sd * foi_cu_2v3*foi_sp + Sncu2v3 * sd * foi_cu_2v3*foi_sn -  sigma * Ecu3v3  + delta3_cu*Ecu3v2
    dEar3v3  =  Spar2v3 * sd * foi_ar_2v3*foi_sp + Snar2v3 * sd * foi_ar_2v3*foi_sn -  sigma * Ear3v3  + delta3_ar*Ear3v2
    dEau3v3  =  Spau2v3 * sd * foi_au_2v3*foi_sp + Snau2v3 * sd * foi_au_2v3*foi_sn -  sigma * Eau3v3  + delta3_au*Eau3v2
    dEer3v3  =  Sper2v3 * sd * foi_er_2v3*foi_sp + Sner2v3 * sd * foi_er_2v3*foi_sn -  sigma * Eer3v3  + delta3_er*Eer3v2
    dEeu3v3  =  Speu2v3 * sd * foi_eu_2v3*foi_sp + Sneu2v3 * sd * foi_eu_2v3*foi_sn -  sigma * Eeu3v3  + delta3_eu*Eeu3v2
    ...
    dEcum2v0_cr = Spcr1v0 * sd * foi_cr_1v0*foi_sp + Sncr1v0 * sd * foi_cr_1v0*foi_sn
    dEcum2v0_cu = Spcu1v0 * sd * foi_cu_1v0*foi_sp + Sncu1v0 * sd * foi_cu_1v0*foi_sn
    dEcum2v0_ar = Spar1v0 * sd * foi_ar_1v0*foi_sp + Snar1v0 * sd * foi_ar_1v0*foi_sn
    dEcum2v0_au = Spau1v0 * sd * foi_au_1v0*foi_sp + Snau1v0 * sd * foi_au_1v0*foi_sn
    dEcum2v0_er = Sper1v0 * sd * foi_er_1v0*foi_sp + Sner1v0 * sd * foi_er_1v0*foi_sn
    dEcum2v0_eu = Speu1v0 * sd * foi_eu_1v0*foi_sp + Sneu1v0 * sd * foi_eu_1v0*foi_sn
    
    dEcum3v0_cr = Spcr2v0 * sd * foi_cr_2v0*foi_sp + Sncr2v0 * sd * foi_cr_2v0*foi_sn
    dEcum3v0_cu = Spcu2v0 * sd * foi_cu_2v0*foi_sp + Sncu2v0 * sd * foi_cu_2v0*foi_sn
    dEcum3v0_ar = Spar2v0 * sd * foi_ar_2v0*foi_sp + Snar2v0 * sd * foi_ar_2v0*foi_sn
    dEcum3v0_au = Spau2v0 * sd * foi_au_2v0*foi_sp + Snau2v0 * sd * foi_au_2v0*foi_sn
    dEcum3v0_er = Sper2v0 * sd * foi_er_2v0*foi_sp + Sner2v0 * sd * foi_er_2v0*foi_sn
    dEcum3v0_eu = Speu2v0 * sd * foi_eu_2v0*foi_sp + Sneu2v0 * sd * foi_eu_2v0*foi_sn
    
    ##One dose vaccine
    dEcum1v1_cr = Spcr0v1 * sd * foi_cr_0v1*foi_sp +Sncr0v1 * sd * foi_cr_0v1*foi_sn 
    dEcum1v1_cu = Spcu0v1 * sd * foi_cu_0v1*foi_sp +Sncu0v1 * sd * foi_cu_0v1*foi_sn 
    dEcum1v1_ar = Spar0v1 * sd * foi_ar_0v1*foi_sp +Snar0v1 * sd * foi_ar_0v1*foi_sn 
    dEcum1v1_au = Spau0v1 * sd * foi_au_0v1*foi_sp +Snau0v1 * sd * foi_au_0v1*foi_sn 
    dEcum1v1_er = Sper0v1 * sd * foi_er_0v1*foi_sp +Sner0v1 * sd * foi_er_0v1*foi_sn 
    dEcum1v1_eu = Speu0v1 * sd * foi_eu_0v1*foi_sp +Sneu0v1 * sd * foi_eu_0v1*foi_sn
    
    dEcum2v1_cr = Spcr1v1 * sd * foi_cr_1v1*foi_sp + Sncr1v1 * sd * foi_cr_1v1*foi_sn
    dEcum2v1_cu = Spcu1v1 * sd * foi_cu_1v1*foi_sp + Sncu1v1 * sd * foi_cu_1v1*foi_sn
    dEcum2v1_ar = Spar1v1 * sd * foi_ar_1v1*foi_sp + Snar1v1 * sd * foi_ar_1v1*foi_sn
    dEcum2v1_au = Spau1v1 * sd * foi_au_1v1*foi_sp + Snau1v1 * sd * foi_au_1v1*foi_sn
    dEcum2v1_er = Sper1v1 * sd * foi_er_1v1*foi_sp + Sner1v1 * sd * foi_er_1v1*foi_sn
    dEcum2v1_eu = Speu1v1 * sd * foi_eu_1v1*foi_sp + Sneu1v1 * sd * foi_eu_1v1*foi_sn
    
    dEcum3v1_cr = Spcr2v1 * sd * foi_cr_2v1*foi_sp + Sncr2v1 * sd * foi_cr_2v1*foi_sn
    dEcum3v1_cu = Spcu2v1 * sd * foi_cu_2v1*foi_sp + Sncu2v1 * sd * foi_cu_2v1*foi_sn
    dEcum3v1_ar = Spar2v1 * sd * foi_ar_2v1*foi_sp + Snar2v1 * sd * foi_ar_2v1*foi_sn
    dEcum3v1_au = Spau2v1 * sd * foi_au_2v1*foi_sp + Snau2v1 * sd * foi_au_2v1*foi_sn
    dEcum3v1_er = Sper2v1 * sd * foi_er_2v1*foi_sp + Sner2v1 * sd * foi_er_2v1*foi_sn
    dEcum3v1_eu = Speu2v1 * sd * foi_eu_2v1*foi_sp + Sneu2v1 * sd * foi_eu_2v1*foi_sn
    
    ##Two dose vaccine
    dEcum1v2_cr = Spcr0v2 * sd * foi_cr_0v2*foi_sp + Sncr0v2 * sd * foi_cr_0v2*foi_sn 
    dEcum1v2_cu = Spcu0v2 * sd * foi_cu_0v2*foi_sp + Sncu0v2 * sd * foi_cu_0v2*foi_sn
    dEcum1v2_ar = Spar0v2 * sd * foi_ar_0v2*foi_sp + Snar0v2 * sd * foi_ar_0v2*foi_sn
    dEcum1v2_au = Spau0v2 * sd * foi_au_0v2*foi_sp + Snau0v2 * sd * foi_au_0v2*foi_sn
    dEcum1v2_er = Sper0v2 * sd * foi_er_0v2*foi_sp + Sner0v2 * sd * foi_er_0v2*foi_sn
    dEcum1v2_eu = Speu0v2 * sd * foi_eu_0v2*foi_sp + Sneu0v2 * sd * foi_eu_0v2*foi_sn
    
    dEcum2v2_cr = Spcr1v2 * sd * foi_cr_1v2*foi_sp + Sncr1v2 * sd * foi_cr_1v2*foi_sn
    dEcum2v2_cu = Spcu1v2 * sd * foi_cu_1v2*foi_sp + Sncu1v2 * sd * foi_cu_1v2*foi_sn
    dEcum2v2_ar = Spar1v2 * sd * foi_ar_1v2*foi_sp + Snar1v2 * sd * foi_ar_1v2*foi_sn
    dEcum2v2_au = Spau1v2 * sd * foi_au_1v2*foi_sp + Snau1v2 * sd * foi_au_1v2*foi_sn
    dEcum2v2_er = Sper1v2 * sd * foi_er_1v2*foi_sp + Sner1v2 * sd * foi_er_1v2*foi_sn
    dEcum2v2_eu = Speu1v2 * sd * foi_eu_1v2*foi_sp + Sneu1v2 * sd * foi_cu_1v2*foi_sn
    
    dEcum3v2_cr = Spcr2v2 * sd * foi_cr_2v2*foi_sp + Sncr2v2 * sd * foi_cr_2v2*foi_sn
    dEcum3v2_cu = Spcu2v2 * sd * foi_cu_2v2*foi_sp + Sncu2v2 * sd * foi_cu_2v2*foi_sn
    dEcum3v2_ar = Spar2v2 * sd * foi_ar_2v2*foi_sp + Snar2v2 * sd * foi_ar_2v2*foi_sn
    dEcum3v2_au = Spau2v2 * sd * foi_au_2v2*foi_sp + Snau2v2 * sd * foi_au_2v2*foi_sn
    dEcum3v2_er = Sper2v2 * sd * foi_er_2v2*foi_sp + Sner2v2 * sd * foi_er_2v2*foi_sn
    dEcum3v2_eu = Speu2v2 * sd * foi_eu_2v2*foi_sp + Sneu2v2 * sd * foi_eu_2v2*foi_sn
    
    ##Three dose vaccine
    dEcum1v3_cr = Spcr0v3 * sd * foi_cr_0v3*foi_sp + Sncr0v3 * sd * foi_cr_0v3*foi_sn
    dEcum1v3_cu = Spcu0v3 * sd * foi_cu_0v3*foi_sp + Sncu0v3 * sd * foi_cu_0v3*foi_sn
    dEcum1v3_ar = Spar0v3 * sd * foi_ar_0v3*foi_sp + Snar0v3 * sd * foi_ar_0v3*foi_sn
    dEcum1v3_au = Spau0v3 * sd * foi_au_0v3*foi_sp + Snau0v3 * sd * foi_au_0v3*foi_sn
    dEcum1v3_er = Sper0v3 * sd * foi_er_0v3*foi_sp + Sner0v3 * sd * foi_er_0v3*foi_sn
    dEcum1v3_eu = Speu0v3 * sd * foi_eu_0v3*foi_sp + Sneu0v3 * sd * foi_eu_0v3*foi_sn
    
    dEcum2v3_cr = Spcr1v3 * sd * foi_cr_1v3*foi_sp + Sncr1v3 * sd * foi_cr_1v3*foi_sn
    dEcum2v3_cu = Spcu1v3 * sd * foi_cu_1v3*foi_sp + Sncu1v3 * sd * foi_cu_1v3*foi_sn
    dEcum2v3_ar = Spar1v3 * sd * foi_ar_1v3*foi_sp + Snar1v3 * sd * foi_ar_1v3*foi_sn
    dEcum2v3_au = Spau1v3 * sd * foi_au_1v3*foi_sp + Snau1v3 * sd * foi_au_1v3*foi_sn
    dEcum2v3_er = Sper1v3 * sd * foi_er_1v3*foi_sp + Sner1v3 * sd * foi_er_1v3*foi_sn
    dEcum2v3_eu = Speu1v3 * sd * foi_eu_1v3*foi_sp + Sneu1v3 * sd * foi_eu_1v3*foi_sn
    
    dEcum3v3_cr = Spcr2v3 * sd * foi_cr_2v3*foi_sp + Sncr2v3 * sd * foi_cr_2v3*foi_sn
    dEcum3v3_cu = Spcu2v3 * sd * foi_cu_2v3*foi_sp + Sncu2v3 * sd * foi_cu_2v3*foi_sn
    dEcum3v3_ar = Spar2v3 * sd * foi_ar_2v3*foi_sp + Snar2v3 * sd * foi_ar_2v3*foi_sn
    dEcum3v3_au = Spau2v3 * sd * foi_au_2v3*foi_sp + Snau2v3 * sd * foi_au_2v3*foi_sn
    dEcum3v3_er = Sper2v3 * sd * foi_er_2v3*foi_sp + Sner2v3 * sd * foi_er_2v3*foi_sn
    dEcum3v3_eu = Speu2v3 * sd * foi_eu_2v3*foi_sp + Sneu2v3 * sd * foi_eu_2v3*foi_sn
    ...
    time_varying_pars=c('foi_cr_0v0'=foi_cr_0v0, 'foi_cu_0v0'=foi_cu_0v0, 'foi_ar_0v0'=foi_ar_0v0, 'foi_au_0v0'=foi_au_0v0, 'foi_er_0v0'=foi_er_0v0, 'foi_eu_0v0'=foi_eu_0v0,
                        ...
                        'delta1_cr'=delta1_cr, 'delta1_cu'=delta1_cu, 'delta3_ar'=delta3_ar, 'delta3_au'=delta3_au, 'delta3_er'=delta3_er, 'delta3_eu'=delta3_eu)
