...
#####Read in mod_scen for serologically triggered scenarios and no vax scenario
hpc_folder <- "/projects/blopman/vger/cliu/00_sens_varyfoi/0_foi0.7_kappa2500"
setwd(hpc_folder)

#setwd("C:/Users/cliu369/OneDrive - Emory University/Documents/DIssertation/Aim 3/COVIDVaxSero_sens/8_varyfoi")
##Read in lists of model results
mod_scen1 <- readRDS("mod_scen_vaxint1.RDS")
mod_scen2 <- readRDS("mod_scen_vaxint2.RDS")
mod_scen3 <- readRDS("mod_scen_vaxint3.RDS")
mod_scen4 <- readRDS("mod_scen_vaxint4.RDS")
mod_scen5 <-  readRDS("mod_scen_vaxintsens1.RDS")
mod_scen6 <-  readRDS("mod_scen_vaxintsens2.RDS")
mod_scen7 <-  readRDS("mod_scen_vaxintsens3.RDS")
mod_scen8 <-  readRDS("mod_scen_vaxintsens4.RDS")
mod_scen9 <-  readRDS("mod_scen_vaxintsens5.RDS")
mod_scen10 <- readRDS("mod_scen_vaxintsens6.RDS")
mod_scen11 <- readRDS("mod_scen_vaxintsens7.RDS")
mod_scen12 <- readRDS("mod_scen_vaxintsens8.RDS")
mod_scen13 <- readRDS("mod_scen_vaxintsens9.RDS")


##Combine the pieces into one
mod_scen <- c(mod_scen1,mod_scen2,mod_scen3,mod_scen4,mod_scen5,mod_scen6,
              mod_scen7, mod_scen8, mod_scen9, mod_scen10, mod_scen11,mod_scen12,
              mod_scen13)
...
setwd(hpc_folder)
saveRDS(nnt,    "0_comb_res/vaxint_nnt_full.RDS")
#saveRDS(inc,    "0_comb_res/vaxint_inc_full.RDS")
#saveRDS(sero,   "0_comb_res/vaxint_sero_full.RDS")
#saveRDS(imm,    "0_comb_res/vaxint_imm.RDS")
#saveRDS(imm_med,"0_comb_res/vaxint_imm_med.RDS")
#saveRDS(deaths, "0_comb_res/vaxint_death_full.RDS")
