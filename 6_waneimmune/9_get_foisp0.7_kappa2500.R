...
vaxint_death_main  <- readRDS("0_res/orig/vaxint_death_full.RDS")
#vaxint_imm_med_main<- readRDS("1_main/0_res/orig/vaxint_imm_med.RDS")
vaxint_imm_main    <- readRDS("0_res/orig/vaxint_imm.RDS")
vaxint_inc_main    <- readRDS("0_res/orig/vaxint_inc_full.RDS")
vaxint_nnt_main    <- readRDS("0_res/orig/vaxint_nnt_full.RDS")
vaxint_sero_main   <- readRDS("0_res/orig/vaxint_sero_full.RDS")
...
vax_death_main  <- readRDS("0_res/orig/vaxsero_death.RDS")
vax_imm_main    <- readRDS("0_res/orig/vaxsero_imm.RDS")
vax_inc_main    <- readRDS("0_res/orig/vaxsero_inc.RDS")
vax_nnt_main    <- readRDS("0_res/orig/vaxsero_nnt.RDS")
vax_sero_main   <- readRDS("0_res/orig/vaxsero_sero.RDS")
...
saveRDS(vax_death_comb, "0_res/vaxsero_death.RDS")
saveRDS(vax_imm_comb, "0_res/vaxsero_imm.RDS")
saveRDS(vax_inc_comb, "0_res/vaxsero_inc.RDS")
saveRDS(vax_nnt_comb, "0_res/vaxsero_nnt.RDS")
saveRDS(vax_sero_comb,"0_res/vaxsero_sero.RDS")
saveRDS(vax_imm_med_comb, "0_res/vaxsero_imm_med.RDS")
