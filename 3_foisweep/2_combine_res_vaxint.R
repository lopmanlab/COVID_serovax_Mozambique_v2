...
mod_scen1 <- readRDS("mod_scen_vaxint_pt1_1.RDS")
mod_scen2 <- readRDS("mod_scen_vaxint_pt1_2.RDS")
mod_scen3 <- readRDS("mod_scen_vaxint_pt1_3.RDS")
mod_scen4 <- readRDS("mod_scen_vaxint_pt1_4.RDS")
mod_scen5 <- readRDS("orig/mod_scen_vaxint_pt2_1.RDS")
mod_scen6 <- readRDS("orig/mod_scen_vaxint_pt2_2.RDS")
mod_scen7 <- readRDS("orig/mod_scen_vaxint_pt2_3.RDS")
mod_scen8 <- readRDS("orig/mod_scen_vaxint_pt2_4.RDS")
mod_scen9 <- readRDS("mod_scen_vaxint_pt3_1.RDS")
mod_scen10 <-readRDS("mod_scen_vaxint_pt3_2.RDS")

#mod_scen5 <- readRDS("mod_scen_vax_foisp0.9.RDS")
#Combine the pieces into one
mod_scen <- c(mod_scen1, mod_scen2, mod_scen3, mod_scen4,mod_scen5, mod_scen6, mod_scen7,mod_scen8,mod_scen9,mod_scen10)
...
source("0_postprocess/9_nnt_int.R")
...
source("0_postprocess/9_case_sero_death_timeseries_int.R")
...
list1  <- seq(1:n)
source("0_postprocess/9_imm_timeseries_int.R")
...
##OUTPUT: Year NNT#########################################
##########################################################
#source("0_postprocess/9_annual_int.R")
