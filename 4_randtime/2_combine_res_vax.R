...
hpc_folder <- "/projects/blopman/vger/cliu/00_randtime"
setwd(hpc_folder)
...
mod_scen1 <- readRDS("mod_scen_serovax1.RDS")
mod_scen2 <- readRDS("mod_scen_serovax2.RDS")
mod_scen3 <- readRDS("mod_scen_serovax3.RDS")
mod_scen4 <- readRDS("mod_scen_serovax4.RDS")
mod_scen5 <- readRDS("mod_scen_serovax5.RDS")
mod_scen6 <- readRDS("mod_scen_serovax6.RDS")
